      ...
      <q-card flat>
        ...
        <q-tab-panels v-model="activeTab" animated>
            ...
            <q-form @submit.prevent="handleSubmit">
              <div class="q-gutter-md">
                ...
                <EmailVerifyFields
                  ...
                  @update:confirmationCode="(v: string) => (form.confirmationCode = v)"
                  @send-code="sendCode"
                />
          ...
          <q-tab-panel name="postMessage">
            <q-form @submit.prevent="handleMessageSubmit">
              <div class="q-gutter-md">
                ...
                <EmailVerifyFields
                  ...
                  :confirmation-code="messageForm.confirmationCode"
                  :sending-code="sendingMessageCode"
                  :code-sent="messageCodeSent"
                ...
                <q-checkbox v-model="messageForm.agree" dense>
                  <span :class="!messageForm.agree ? 'text-negative' : ''">I agree with the Message Posting Agreement</span>
                </q-checkbox>
